...
{% figureElement 'website/articles/07-testing-my-eleventy-website-with-cypress-and-netlify/msme-first-tests.png', 'Screenshot of the cypress testrunner showing successful test for the homepage.' %}
...
{% figureElement 'website/articles/07-testing-my-eleventy-website-with-cypress-and-netlify/msme-more-tests.png', 'Screenshot of the cypress testrunner showing successful test for several features.' %}
...
{% figureElement 'website/articles/07-testing-my-eleventy-website-with-cypress-and-netlify/msme-cypress-netlify-complete.jpeg', 'A table showing the positive test results of my cypress test.' %}
